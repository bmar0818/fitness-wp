<?php
    ...
    function fitness_scripts() {
        ...
        //Fonts
        wp_enqueue_style('googlefont', 'https://fonts.googleapis.com/css?family=Lato:300,400,700,900|Staatliches&display=swap', array(), '1.0.0' );
    ...
    /** Displays Hero Image on the front page **/
