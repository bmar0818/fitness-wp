<?php 
    /*
        Plugin Name: Fitnnes - Widgets
        Plugin URI:
        Description: Adds a Custom Widget in Wordpress Panel
        Version: 1.0
 ...
 */
    class Fitness_Classes_Widget extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                ...
                esc_html__( 'Fitness - Classes List', 'text_domain' ), // Name
                array( 'description' => esc_html__( 'Displays Gym Classes in the Widget', 'text_domain' ), ) // Args
            );
        }
        ...
        */
        public function widget( $args, $instance ) {
            ...
            <h2 class="text-center classes-header">
                <?php echo esc_html($instance['title']); ?>
            </h2>

            <ul class= "sidebar-classes-list text-center">
                <?php 
                    $args = array( 
    ...
    function fitness_classes_widget() {
        register_widget( 'Fitness_Classes_Widget' );
    }
    add_action( 'widgets_init', 'fitness_classes_widget' );
?>